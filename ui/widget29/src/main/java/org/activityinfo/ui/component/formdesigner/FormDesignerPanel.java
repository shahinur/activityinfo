...
import org.activityinfo.ui.component.formdesigner.container.SectionWidgetContainer;
import org.activityinfo.ui.component.formdesigner.container.WidgetContainer;
import org.activityinfo.ui.component.formdesigner.drop.NullValueUpdater;
import org.activityinfo.ui.component.formdesigner.event.WidgetContainerSelectionEvent;
import org.activityinfo.ui.component.formdesigner.header.HeaderPanel;
import org.activityinfo.ui.component.formdesigner.palette.FieldPalette;
import org.activityinfo.ui.component.formdesigner.properties.PropertiesPanel;
 ...
 */
public class FormDesignerPanel extends Composite implements Window.ScrollHandler  {

    private static final Logger LOGGER = Logger.getLogger(FormDesignerPanel.class.getName());
    ...
    public FormDesignerPanel(final ResourceLocator resourceLocator, @Nonnull final FormClass formClass) {
        ...
        addAttachHandler(new AttachEvent.Handler() {
            ...
            public void onAttachOrDetach(AttachEvent event) {
                scrollHandlerRegistration = Window.addWindowScrollHandler(FormDesignerPanel.this);
            }
        });
    ...
    private void calcSpacerHeight() {
        int verticalScrollPosition = Window.getScrollTop();
    ...
    protected void onDetach() {
        ...
        LOGGER.log(Level.INFO, "FormDesignerPanel detaching.");
    }
}
