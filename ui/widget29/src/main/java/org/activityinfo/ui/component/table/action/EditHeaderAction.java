...
public class EditHeaderAction implements TableHeaderAction {
    ...
    public void render(Cell.Context context, String value, SafeHtmlBuilder sb) {
        ...
        if (hasSelection) {
            sb.append(TEMPLATE.enabled(uniqueId, FontAwesome.EDIT.getClassNames(), I18N.CONSTANTS.edit()));
        } else {
            sb.append(TEMPLATE.disabled(uniqueId, FontAwesome.EDIT.getClassNames(), I18N.CONSTANTS.edit()));
        }
    }
