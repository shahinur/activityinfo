...
import org.activityinfo.io.importing.source.SourceTable;
import org.activityinfo.ui.component.importDialog.PageChangedEvent;
...
public class ColumnMappingGrid extends DataGrid<SourceRow> {
    ...
    public void refresh() {
        ...
        for (SourceColumn sourceColumn : sourceColumns) {
            ...
            this.setColumnWidth(gridColumn, ColumnWidths.columnWidthInEm(sourceColumn.getHeader()),
