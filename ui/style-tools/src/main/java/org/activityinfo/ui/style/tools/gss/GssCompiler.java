...
public class GssCompiler {
    ...
    public GssTree compile(TreeLogger logger, String css) throws UnableToCompleteException {
        ...
        TreeLogger branchLogger = logger.branch(TreeLogger.DEBUG, "Parsing LESS output as GSS stylesheet");
    ...
    private void finalizeTree(TreeLogger logger, CssTree cssTree) {
        LoggingErrorManager errorManager = new LoggingErrorManager(logger.branch(TreeLogger.Type.INFO,
                "Finalizing Closure Stylesheet"));
