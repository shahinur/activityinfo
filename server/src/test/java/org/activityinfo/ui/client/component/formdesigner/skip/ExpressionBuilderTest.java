...
public class ExpressionBuilderTest {
    ...
    public void simpleEnumValueExpression() {
        ...
        row.setValue(new EnumValue(Sets.newHashSet(enumItem(GENDER_FIELD_ID, "Male").getId())));
        ...
        row2.setValue(new EnumValue(Sets.newHashSet(enumItem(PREGNANT_FIELD_ID, "No").getId())));
        ...
        row2.setValue(new EnumValue(Sets.newHashSet(
                enumItem(PREGNANT_FIELD_ID, "Yes").getId(),
                enumItem(PREGNANT_FIELD_ID, "No").getId())));
