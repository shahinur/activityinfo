...
public class SkipExpressionTest {
    ...
    public void enumType() {
        ...
        // enum with 2 values
        instance.set(GENDER_FIELD_ID,  new EnumItem(enumValue(GENDER_FIELD_ID, "Male").getId(), enumValue(GENDER_FIELD_ID, "Female").getId()));
    ...
    private EnumItem enumFieldValue(ResourceId formField, String label) {
        return new EnumItem(enumValue(formField, label).getId());
    }
