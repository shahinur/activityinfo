...
public class Types {
    ...
    public static FieldValue read(Record bag, String name, RecordFieldTypeClass typeClass) {
    ...
    public static ResourceId readReference(Record bag, String name) {
        FieldValue value = read(bag, name, ReferenceType.TYPE_CLASS);

        if (value instanceof ReferenceValue) {
            return ((ReferenceValue) value).getResourceId();
        }
