...
public abstract class TreeNode<T extends TreeNode> implements Serializable {
    ...
    /**
     * @return The depth of the subtree starting at this node. (0 if this node
     * has no children, 1 if all of it's children are leaves, 2 if this
     * node has grand children, etc)
     */
     ...
     *
     * @param depth
     * @param placeholders if true, null values are added to the list when a subtree has
     *                     no nodes at the given depth
     * @return
     */
