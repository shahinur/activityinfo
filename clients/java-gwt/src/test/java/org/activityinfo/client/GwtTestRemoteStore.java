...
import org.activityinfo.client.resource.ResourceParser;
import org.activityinfo.client.resource.UserResourceParser;
...
public class GwtTestRemoteStore extends GWTTestCase {
    ...
    public void testGet() throws Exception {
        ...
        ActivityInfoAsyncClient service = getStore();
    ...
    private ActivityInfoAsyncClient getStore() {
        return new ActivityInfoAsyncClientImpl(new RestEndpoint(GWT.getModuleBaseURL()));
    }
